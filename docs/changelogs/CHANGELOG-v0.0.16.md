...
- Commit subjects in the Changes history marquee-scroll on their row's hover — a too-long title eases leftwards to reveal its tail, like branch names in the Worktrees navigator.
